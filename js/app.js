...
const tonic = new ProjectContructor(
...
const multiPostSories = new ProjectContructor(
...
const facebook360 = new ProjectContructor(
...
const uberNavigation = new ProjectContructor(
...
const projects = [tonic, multiPostSories, facebook360, uberNavigation];

function generateTechnologyList(technologyArray) {
  let technologyList = '';

  for (let i = 0; i < technologyArray.length; i += 1) {
...
let worksCardsButtons;
let quitPopUp;
const worksPopUpSection = document.getElementById('works-pop-up');
